...
public partial class Camera : Camera2D
{
    ...
    public void RoundZoom()
    {
        ...
        var twen = CreateTween().TweenProperty(this, "zoom", new Vector2(zoomAmount, zoomAmount), zoomSpeed).SetTrans(Tween.TransitionType.Sine).SetEase(Tween.EaseType.InOut);
